...
function RouteComponent() {
  ...
  const nameInputClass = `h-[42px] w-full rounded-full ${
    showErrors && !allianceName
      ...
      : "px-[14px]"
  } bg-[#F7FFEB0F] text-xs text-white placeholder-gray-400 focus:border-[#76AD10] focus:ring-1 focus:ring-[#A2D448] focus:outline-none`;
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="relative mb-[18px] w-full">
            <input
              ...
              className="h-[42px] w-full rounded-full bg-[#F7FFEB0F] px-[14px] text-xs text-white placeholder-gray-400 focus:border-[#76AD10] focus:ring-1 focus:ring-[#A2D448] focus:outline-none"
              size={500}
              value={telegramUrl}
